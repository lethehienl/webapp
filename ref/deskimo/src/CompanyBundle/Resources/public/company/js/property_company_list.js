    ...
    initComponents: function () {
        ...
        var actions = {
            mRender: function (data, type, row) {
                var updateUrl = envUrlPrefix + '/admin/property/company/' + row[0] + '/update';
                var deleteUrl = envUrlPrefix + '/admin/property/company/' + row[0] + '/delete';
                ...
                var editLink = `
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton${row[0]}">
                    ...
                    <a class="dropdown-item invite" data-company-id="${row[0]}" href="#">Invite</a>
                  </div>
                </div>`;
        ...
        var info = {
            ...
            ajax_url: envUrlPrefix + '/admin/property/company/search',
