    ...
    initComponents: function () {
        ...
        var actions = {
            mRender: function (data, type, row) {
                var updateUrl = envUrlPrefix + '/admin/property/location/' + row[0] + '/update';
                var deleteUrl = envUrlPrefix + '/admin/property/location/' + row[0] + '/delete';
                ...
                var editLink = `
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton${row[0]}">
                    ...
                    <a class="dropdown-item delete-element" data-id="${row[0]}" href="javascript:void(0)">Delete</a>
                  </div>
                </div>`;
        ...
        var info = {
            ...
            ajax_url: envUrlPrefix + '/admin/property/location/search',
    ...
    delete: function () {
        return function () {
            ...
            deleteElement.bind('click', function () {
                ...
                SwalCommon.deleteConfirm('Are you sure to delete this location?', function () {
                    var requestUrl = envUrlPrefix + '/admin/property/location/' + id + '/delete';
