...
class RolesUtil
{
    ...
    const ROLE_MAPPING_KEY = [
      self::ROLE_FREE_MEMBER_ID => self::ROLE_FREE_MEMBER,
      self::ROLE_CUSTOMER_ID => self::ROLE_CUSTOMER,
      self::ROLE_AGENCY_STAFF_ID => self::ROLE_AGENCY_STAFF,
      self::ROLE_AGENCY_ADMIN_ID => self::ROLE_AGENCY_ADMIN,
      self::ROLE_WEBAPP_STAFF_ID => self::ROLE_WEBAPP_STAFF,
      self::ROLE_WEBAPP_ADMIN_ID => self::ROLE_WEBAPP_ADMIN
    ];
    const ROLE_MAPPING = [
